...
const About = () => {
  ...
  return (
    <>
      <div className="-mt-20 lg:mt-20 pb-30 pt-0 lg:pb-30 lg:pt-30 text-zinc-300">
        <div className="w-11/12 mx-auto flex flex-col-reverse lg:flex-row justify-center gap-20 lg:gap-50">
          ...
          <div className="w-full lg:w-1/2 relative z-0">
            <img
              className="w-full h-[30vh] lg:h-[60vh] rounded-lg lg:rounded-2xl"
            ...
            <div className="p-2 lg:p-4 bg-black absolute left-0 -bottom-10 lg:-bottom-14 lg:-left-20 z-20 rounded-lg lg:rounded-2xl">
              <img
                className="w-30 h-20 lg:w-70 lg:h-50 rounded-lg lg:rounded-2xl"
                src="/homepage/about/about-img2.png"
                alt=""
              />
            </div>
            <div className="p-4 bg-black absolute -top-10 lg:-top-20 -right-3 z-20 rounded-lg lg:rounded-2xl">
              <img
                className="w-30 h-20 lg:w-70 lg:h-50 rounded-lg lg:rounded-2xl"
