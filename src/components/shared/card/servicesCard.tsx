    ...
    <>
      ...
      >
        <div className="flex justify-center">
          <span
            className={`text-5xl text-zinc-400 group-hover:text-primary p-4 rounded-full border border-zinc-700 bg-[#0e0e0e] hover:bg-[#121212]`}
          >
            {item.icon}
          </span>
        </div>
        ...
        <p
          className={`mt-6 transition-all ease-in-out duration-400 ${
